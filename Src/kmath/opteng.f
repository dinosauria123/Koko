...
C       NW3=WAVELENGTH IN MICROMETER (DEFAULT = 0.5461)
...
C     WC IS PLANK
 ...
 35               FORMAT('RADIANT EMITTANCE = ',G23.15,' WATTS/CM2-MICROMETER')

                  IF(RADUNI.EQ.2) WRITE(OUTLYNE,45) VAL
 45               FORMAT('RADIANT PHOTON EMITTANCE = ',G23.15,
     1            ' PHOTONS/SEC-CM2-MICROMETER')
                  CALL SHOWIT(0)
              END IF
              REG(40)=REG(9)
              REG(9)=VAL
...
C     HEADING
 ...
 151              FORMAT('BELOW ',G14.6,' MICROMETER')
 152              FORMAT('IN THE ',G14.6,' TO ',G14.6,' MICROMETER BAND')
C
...
C
 ...
 2020     FORMAT('         WAVELENGTH = ',G15.6,1X,'MICROMETER')
...
C
 ...
 2001     FORMAT('          PART DIAMETER = ',G15.6,1X,A11)
 2002     FORMAT('             WAVELENGTH = ',G12.4,' MICROMETER')
