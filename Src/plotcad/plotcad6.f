...
C
          ...
          INCLUDE 'datpts.inc'
C
          IF(SYSTEM1(6).EQ.1.0D0) UN='INCH '
          IF(SYSTEM1(6).EQ.2.0D0) UN='CM   '
          IF(SYSTEM1(6).EQ.3.0D0) UN='MM   '
          IF(SYSTEM1(6).EQ.4.0D0) UN='METER'
          YSTEP=120
C
...
C     LINE 13, PERMANENT BOXED DATA (UNITS)
     ...
     1    CALL MY_JUSTSTRING(5725,1050,'UNITS: INCH',NT1ANG,NT1SIZ,3)
     ...
     1    CALL MY_JUSTSTRING(5725,1050,'UNITS: METER',NT1ANG,NT1SIZ,3)
...
C     RADTOL2 VALUE
          IF(.NOT.FLAT2) THEN
              ...
              CALL MY_JUSTSTRING(1075,6325,SVAL,NT1ANG,NT1SIZ,3)
          ELSE
              CALL MY_PLOT(1050,6250,0,0,-500,10500,-500,7500)
...
C     RADTOL2 VALUE/FRINGES
          IF(.NOT.FLAT2) THEN
              RADTOL2=RADTOL2/DLPF2
              SVAL=DRAWVL1(DABS(RADTOL2))
              CALL MY_JUSTSTRING(1575,6325,SVAL,NT1ANG,NT1SIZ,3)
          ELSE
              CALL MY_PLOT(1775,6250,0,0,-500,10500,-500,7500)
...
C     FRNG2 VALUE
          SVAL=DRAWVL1(FRNG2)
          CALL MY_JUSTSTRING(2050,6325,SVAL,NT1ANG,NT1SIZ,3)
C
C     SAG TO FLAT 2 VALUE
          IF(PODB2.LT.PODB1.AND.CV2.NE.0.0D0) THEN
              SVAL=DRAWVL1(PODB2)
              CALL MY_JUSTSTRING(2525,6325,SVAL,NT1ANG,NT1SIZ,3)
          ELSE
              CALL MY_PLOT(2775,6250,0,0,-500,10500,-500,7500)
...
C     SAGTOL2
              SVAL=DRAWVL1(SAGTL2)
              CALL MY_JUSTSTRING(3025,6325,SVAL,NT1ANG,NT1SIZ,3)
          ELSE
              CALL MY_PLOT(3275,6250,0,0,-500,10500,-500,7500)
