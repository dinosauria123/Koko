...
C
     ...
     1    HROW(0:100),HROW2(0:100)
          CHARACTER AI*3,BLANK*12,HEADL1*132,
     2    HEADL2*132,HEADL3*80,HEADL4*80,BL12*12
          INTEGER NROW,NCOL,I,J,FROW,FCOL
          REAL*8 TABL(0:100,0:9)
          logical ex
...
C SUB ZMX2PRG.FOR
     ...
     3    ,FIELDTYPE*3,CLTYPE*1,COTYPE*1,TEMPCC*1024,TEMPCCC*1024
          ...
          INTEGER I,KDPFILENAMELENGTH,NPERIOD,ALLOERR
...
C
          ...
          ZMXFILENAME=DIRLEN//TRIM(WS)
          write(6,*) ZMXFILENAME

          EXIS37=.FALSE.
          INQUIRE(FILE=TRIM(ZMXFILENAME),EXIST=EXIS37)
          IF(.NOT.EXIS37) THEN
...
C     CLOSE IT IF OPEN AND KEEP IT
     ...
     1    ,FORM='FORMATTED',FILE=TRIM(ZMXFILENAME)
     2    ,STATUS='UNKNOWN')
