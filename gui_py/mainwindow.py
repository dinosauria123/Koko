...
class KokoMainWindow(QMainWindow, Ui_MainWindow):
    ...
    def _wire_menus(self):
        ...
        actions = [
            ...
            # Aberration fans (koko requires SPD ray-trace data first)
            ('actionXYFAN', self.slot_plot, 'SPOT RING', 'SPD', 'PLTXYFAN'),
            ('actionYXFAN', self.slot_plot, 'SPOT RING', 'SPD', 'PLTYXFAN'),
            ('actionXFAN', self.slot_plot, 'SPOT RING', 'SPD', 'PLTXFAN'),
            ('actionYFAN', self.slot_plot, 'SPOT RING', 'SPD', 'PLTYFAN'),
            ('actionNFAN', self.slot_plot, 'SPOT RING', 'SPD', 'PLTNFAN'),
            ('actionPFAN', self.slot_plot, 'SPOT RING', 'SPD', 'PLTPFAN'),
            ('actionXOPD', self.slot_plot, 'SPOT RING', 'SPD', 'PLTXFAN OPD'),
            ('actionYOPD', self.slot_plot, 'SPOT RING', 'SPD', 'PLTYFAN OPD'),
            ('actionXYOPD', self.slot_plot, 'SPOT RING', 'SPD', 'PLTXYFAN OPD'),
            ('actionNOPD', self.slot_plot, 'SPOT RING', 'SPD', 'PLTNFAN OPD'),
            ('actionPOPD', self.slot_plot, 'SPOT RING', 'SPD', 'PLTPFAN OPD'),
            ('actionXCD', self.slot_plot, 'SPOT RING', 'SPD', 'PLTXFAN CD'),
            ('actionYCD', self.slot_plot, 'SPOT RING', 'SPD', 'PLTYFAN CD'),
            ('actionXYCD', self.slot_plot, 'SPOT RING', 'SPD', 'PLTXYFAN CD'),
            ('actionYXCD', self.slot_plot, 'SPOT RING', 'SPD', 'PLTYXFAN CD'),
            ('actionNCD', self.slot_plot, 'SPOT RING', 'SPD', 'PLTNFAN CD'),
            ('actionPCD', self.slot_plot, 'SPOT RING', 'SPD', 'PLTPFAN CD'),
            ('actionXLA', self.slot_plot, 'SPOT RING', 'SPD', 'PLTXFAN LA'),
            ('actionYLA', self.slot_plot, 'SPOT RING', 'SPD', 'PLTYFAN LA'),
            ('actionXYLA', self.slot_plot, 'SPOT RING', 'SPD', 'PLTXYFAN LA'),
            ('actionYXLA', self.slot_plot, 'SPOT RING', 'SPD', 'PLTYXFAN LA'),
            ('actionNLA', self.slot_plot, 'SPOT RING', 'SPD', 'PLTNFAN LA'),
            ('actionPLA', self.slot_plot, 'SPOT RING', 'SPD', 'PLTPFAN LA'),
            # Edit
