...
class KokoMainWindow(QMainWindow, Ui_MainWindow):
    ...
    def _wire_menus(self):
        ...
        actions = [
            ...
            # Aberration fans
            ('actionXYFAN', self.slot_plot, 'PLTXYFAN'),
            ('actionYXFAN', self.slot_plot, 'PLTYXFAN'),
            ('actionXFAN', self.slot_plot, 'PLTXFAN'),
            ('actionYFAN', self.slot_plot, 'PLTYFAN'),
            ('actionNFAN', self.slot_plot, 'PLTNFAN'),
            ('actionPFAN', self.slot_plot, 'PLTPFAN'),
            ('actionXOPD', self.slot_plot, 'PLTXFAN OPD'),
            ('actionYOPD', self.slot_plot, 'PLTYFAN OPD'),
            ('actionXYOPD', self.slot_plot, 'PLTXYFAN OPD'),
            ('actionNOPD', self.slot_plot, 'PLTNFAN OPD'),
            ('actionPOPD', self.slot_plot, 'PLTPFAN OPD'),
            ('actionXCD', self.slot_plot, 'PLTXFAN CD'),
            ('actionYCD', self.slot_plot, 'PLTYFAN CD'),
            ('actionXYCD', self.slot_plot, 'PLTXYFAN CD'),
            ('actionYXCD', self.slot_plot, 'PLTYXFAN CD'),
            ('actionNCD', self.slot_plot, 'PLTNFAN CD'),
            ('actionPCD', self.slot_plot, 'PLTPFAN CD'),
            ('actionXLA', self.slot_plot, 'PLTXFAN LA'),
            ('actionYLA', self.slot_plot, 'PLTYFAN LA'),
            ('actionXYLA', self.slot_plot, 'PLTXYFAN LA'),
            ('actionYXLA', self.slot_plot, 'PLTYXFAN LA'),
            ('actionNLA', self.slot_plot, 'PLTNFAN LA'),
            ('actionPLA', self.slot_plot, 'PLTPFAN LA'),
            # Edit
